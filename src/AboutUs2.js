      ...
      <nav className={`navbar about-navbar ${isScrolled ? 'scrolled' : ''}`}>
        <div className="navbar-container">
          ...
          <div className="about-nav-links">
            <Link to="/medicines1" className="nav-link">Back to Home</Link>
          </div>
        </div>
      </nav>
          ...
          <div className="contact-content">
            <div className="contact-info">
              ...
              <div className="contact-buttons">
                <Link to="/PendingDonations" className="btn btn-primary">Collect Donations</Link>
                <Link to="/application" className="btn btn-secondary">Distribute Medicines</Link>
              </div>
            </div>
